...
📊 **Dataset**: The <span style="color:#058120;">**IAP Compound climatic impact-drivers (CIDs) monitoring dataset**</span> (version 0.1) can be accessed [here](http://www.ocean.iap.ac.cn/ftp/cheng/Compound_CIDs/). This dataset provides the time of emergence (ToE) for individual CIDs (temperature, salinity, dissolved oxygen, and surface pH) and their compound changes estimation **from 1980 to 2023 at 1-degree box from 0-1000m in the global ocean**. A backup link to download this dataset is [here](../files/IAP_Compound_CID_dataset_v0.1.zip).
...
# <span style="color:#058120;">!! News in Tan et al., 2025, *Scientific Data* !! 🐋🐋</span>
...
[1] **Tan, Z**., K. v. Schuckmann, S. Speich, L. Bopp, J. Zhu, and L. Cheng. (2025): Observed large-scale and deep-reaching compound ocean state changes over the past 60 years. ***Nature Climate Change***. [https://doi.org/10.1038/s41558-025-02484-x](https://doi.org/10.1038/s41558-025-02484-x)
